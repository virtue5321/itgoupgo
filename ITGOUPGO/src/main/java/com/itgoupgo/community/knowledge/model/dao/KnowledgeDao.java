...
public class KnowledgeDao {
	...
	public int selectListCount(SqlSessionTemplate sqlSession) {
		...
		return sqlSession.selectOne("adminMapper.selectKnowledgeListCount");
	}
	...
	public List<KnowledgeBbs> selectList(SqlSessionTemplate sqlSession, RowBounds rowBounds) {
		...
		return sqlSession.selectList("adminMapper.selectKnowledgeList", null, rowBounds);
	}
	...
	public int deleteKnowledgeBbs(SqlSessionTemplate sqlSession, int knowledgeNo) {
		...
		return sqlSession.update("adminMapper.deleteKnowledgeBbs", knowledgeNo);
	}
	
	public int deleteKnowledgeBbsCheck(SqlSessionTemplate sqlSession, List<Integer> bbsNoList) {

		return sqlSession.update("adminMapper.deleteKnowledgeBbsCheck", bbsNoList);
    }
}
