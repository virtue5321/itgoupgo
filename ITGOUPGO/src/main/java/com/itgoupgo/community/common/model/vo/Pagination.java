...
public class Pagination {
    ...
    // =======================================================
    // 📢 추가된 메소드 (getBoardLimit() 오류 해결)
    // listLimit 값을 반환하여 getBoardLimit() 호출 에러를 해결합니다.
    // =======================================================
	...
	public static PageInfo getPageInfo(int searchCount, int currentPage2, int pageLimit2, int boardLimit) {
