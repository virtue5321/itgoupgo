            ...
            <ul>
                ...
                <li id="postManageMenu" class="menu-open">
                    ...
                    <ul class="submenu">
		                ...
		                <li><a href="<c:url value="/admin/knowledgeBbsManage" />" class="sub-active">지식인 게시판</a></li>
                    </ul>
                </li>
                        ...
                        <c:when test="${!empty knowledgeBbsList}">
                            <c:forEach var="post" items="${knowledgeBbsList}">
                                <tr class="${post.knowledgeDeleteStatus eq 'Y' ? 'deleted-post' : ''}">
                                    ...
                                    <td class="text-start">
                                        <c:choose>
                                            <c:when test="${post.knowledgeDeleteStatus eq 'Y'}">
                                                <span class="text-danger">❌ [삭제됨]</span> ${post.knowledgeTitle}
                                            </c:when>
                                            <c:otherwise>
                                    ...
                                    <td>${post.knowledgeView}</td>
                                    <td class="action-cell">
                                        <c:choose>
                                            <c:when test="${post.knowledgeDeleteStatus eq 'N'}">
