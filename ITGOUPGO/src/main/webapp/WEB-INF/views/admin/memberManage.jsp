  ...
  <div class="layout">
    <aside class="sidebar">
      <ul>
        ...
        <%-- ✅ [수정] 게시글 관리 메뉴에 드롭다운 구조 추가 --%>
        <li id="postManageMenu">
    ...
    <main>
      ...
      <form class="search-form" id="searchForm" 
            action="<c:url value="/admin/searchMemberName" />" method="get" 
        ...
        <tbody>
          <c:choose>
            <c:when test="${empty memberList}">
              <tr>
                <td colspan="9">
                    <c:if test="${not empty searchKeyword}">"${searchKeyword}"에 대한 검색 결과가 없습니다.</c:if>
                    <c:if test="${empty searchKeyword}">등록된 회원 정보가 없습니다.</c:if>
                </td>
              </tr>
            </c:when>
            <c:otherwise>
      ...
      <div class="pagination-container">
        ...
        <c:choose>
            ...
            <c:otherwise>
                <c:set var="pageLinkUrl" value="/admin/member" />
