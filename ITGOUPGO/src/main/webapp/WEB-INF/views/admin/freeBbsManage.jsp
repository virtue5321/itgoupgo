...
<body>
    ...
    <div class="layout">
        ...
        <main>
            ...
            <form id="bulkDeleteForm" action="<c:url value="/admin/deleteFreeBbsCheck" />" method="post" style="display:none;"></form>
                    ...
                    <c:choose>
                        ...
                        <c:otherwise>
                            <c:forEach var="post" items="${freeBbsList}">
                                <tr class="${post.freeDeleteStatus eq 'Y' ? 'deleted-post' : ''}">
                                    ...
                                    <td class="text-start">
                                        <c:choose>
                                            <c:when test="${post.freeDeleteStatus eq 'Y'}">
                                                <span class="text-danger">❌ [삭제됨]</span> ${post.freeTitle}
                                            </c:when>
                                            <c:otherwise>
                                    ...
                                    <td class="action-cell">
                                        <c:choose>
                                            <c:when test="${post.freeDeleteStatus eq 'N'}">
                                                <button class="btn btn-danger"
                                                    onclick="if(confirm('${post.freeNo}번 게시글을 정말 삭제하시겠습니까?')) { location.href='<c:url value="/admin/deleteFreeBbs?bbsNo=${post.freeNo}" />'; }">
                                                    삭제
                                                </button>
                                            </c:when>
                                            <c:otherwise>
