...
/* 다크 모드일 때 카드 스타일 */
[data-theme="dark"] .carousel-item-custom .card {
    background-color: #2c2c31; /* 어두운 배경색 */
    border-color: rgba(255, 255, 255, 0.1); /* 밝은 테두리 */
...
/* 다크 모드일 때 카드 텍스트 색상 */
[data-theme="dark"] .carousel-item-custom .card-text {
...
/* 다크 모드일 때 카드 푸터 테두리 */
[data-theme="dark"] .carousel-item-custom .card-footer {
    border-top-color: rgba(255, 255, 255, 0.05); /* 밝은 테두리 */
    color: #b0b0b0; /* 밝은 회색 텍스트 */
}
...
[data-theme="dark"] .carousel-control-next-icon {
    background-color: var(--btn-login); /* 다크 모드 아이콘 배경색 */
}
...
[data-theme="dark"] .carousel-indicators [data-bs-target] {
    background-color: var(--btn-login); /* 다크 모드 인디케이터 색상 */
}
[data-theme="dark"] .carousel-indicators .active {
    background-color: var(--btn-signup); /* 다크 모드 활성화된 인디케이터 색상 */
}
